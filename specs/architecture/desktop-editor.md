...
- **Activate:** Same interaction rules as wiki links (click, **Mod-click**, **Mod-Enter** inside the URL; **Shift+click** not intercepted). [`markdownInlineLinkUrlAtPosition.ts`](../../apps/desktop/src/editor/noteEditor/markdownInlineLinkUrlAtPosition.ts) maps the caret/click to the Lezer **`Link` → `URL`** span (skips **`Image`**). Shell handler: [`openOrCreateVaultRelativeMarkdownLink`](../../apps/desktop/src/lib/inboxWikiLinkNavigation.ts) after flush in [`useMainWindowWorkspace`](../../apps/desktop/src/hooks/useMainWindowWorkspace.ts).
- **Highlighting:** [`markdownRelativeLinkCodemirror.ts`](../../apps/desktop/src/editor/noteEditor/markdownRelativeLinkCodemirror.ts) decorates URL spans; [`inboxRelativeMarkdownLinkHrefIsResolved`](../../apps/desktop/src/lib/inboxWikiLinkNavigation.ts) matches the navigation “note exists in index” rule.
