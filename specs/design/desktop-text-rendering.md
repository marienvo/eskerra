...
| Vault search palette | **`.vault-search-content`**: **`-webkit-font-smoothing: antialiased`**, **`font-synthesis: none`**, **`text-rendering: auto`**; snippets **inherit UI sans** (no **`ui-monospace`** on **`.vault-search-hit__snippet`**) | `App.css`, **`VaultSearchPalette.tsx`** |
