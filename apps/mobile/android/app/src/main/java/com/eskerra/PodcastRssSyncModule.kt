...
import com.eskerra.podcast.rss.PodcastHubLinks
import com.eskerra.podcast.rss.PodcastMarkdownNaming
import com.eskerra.podcast.rss.PieMarkdownParser
import com.eskerra.podcast.rss.PodcastRssFileSync
import com.eskerra.podcast.rss.PodcastsMdMerge
import com.eskerra.podcast.rss.RssByteFetcher
...
class PodcastRssSyncModule(private val reactContext: ReactApplicationContext) :
  ...
  private val executor =
    Executors.newSingleThreadExecutor { r ->
      Thread(r, "EskerraPodcastRssSync").apply { isDaemon = true }
    }
  ...
  companion object {
    const val MODULE_NAME = "EskerraPodcastRssSync"
    private const val TAG = "EskerraPodcastRssSync"
    private const val E_INVALID_ARG = "E_PODCAST_RSS_INVALID_ARG"
    private const val E_SYNC_FAILED = "E_PODCAST_RSS_SYNC_FAILED"
    const val EVENT_PROGRESS = "EskerraPodcastRssSyncProgress"
