/**
 * Inbox compose format: first line is the title (for the filename stem); remaining lines are the body.
 * Matches the mobile `TextInput` compose model in `AddNoteScreen`.
 */

export type ParsedComposeInput = {
...
export function buildInboxMarkdownFromCompose(titleLine: string, bodyAfterBlank: string): string {
